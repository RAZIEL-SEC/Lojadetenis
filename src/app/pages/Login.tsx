  ...
  return (
    <Layout>
      <div className="max-w-7xl mx-auto px-4 py-16">
        <div className="max-w-md mx-auto bg-white border border-gray-200 rounded-lg p-8 shadow-lg">
          ...
          <div className="mt-8 pt-6 border-t border-gray-200">
            <p className="text-sm text-center text-gray-600 mb-4">Ou continue com</p>
